...
const pb_field_t AllTypes_fields[59] = {
    ...
    PB_FIELD( 98, MESSAGE , REQUIRED, STATIC  , OTHER, AllTypes, req_limits, opt_emptymsg, &Limits_fields),
    PB_FIELD( 99, INT32   , REQUIRED, STATIC  , OTHER, AllTypes, end, req_limits, 0),
    PB_FIELD(100, MESSAGE , OPTIONAL, STATIC  , OTHER, AllTypes, message, end, &Message_fields),
    PB_FIELD(200, EXTENSION, OPTIONAL, CALLBACK, OTHER, AllTypes, extensions, message, 0),
    PB_LAST_FIELD
};
 ...
 * field descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(AllTypes, req_submsg) < 65536 && pb_membersize(AllTypes, req_emptymsg) < 65536 && pb_membersize(AllTypes, rep_submsg[0]) < 65536 && pb_membersize(AllTypes, rep_emptymsg[0]) < 65536 && pb_membersize(AllTypes, opt_submsg) < 65536 && pb_membersize(AllTypes, opt_emptymsg) < 65536 && pb_membersize(AllTypes, req_limits) < 65536 && pb_membersize(AllTypes, message) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_SubMessage_EmptyMessage_Limits_AllTypes)
#endif
 ...
 * 8 bit descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(AllTypes, req_submsg) < 256 && pb_membersize(AllTypes, req_emptymsg) < 256 && pb_membersize(AllTypes, rep_submsg[0]) < 256 && pb_membersize(AllTypes, rep_emptymsg[0]) < 256 && pb_membersize(AllTypes, opt_submsg) < 256 && pb_membersize(AllTypes, opt_emptymsg) < 256 && pb_membersize(AllTypes, req_limits) < 256 && pb_membersize(AllTypes, message) < 256), YOU_MUST_DEFINE_PB_FIELD_16BIT_FOR_MESSAGES_SubMessage_EmptyMessage_Limits_AllTypes)
#endif
